  ...
  function insertarAlergias(ALERGIAS, IDINFORMACIONSALUD) {
    return new Promise((resolve, reject) => {
      ALERGIAS.forEach((ALERGIA) => {
        ...
        connection.connection.query(alergiasquery, (err, resultadoqueryalergia) => {
          if (err) {
            reject(err);
          } else {
  ...
  function insertarMedicamentos(MEDICAMENTOS, IDINFORMACIONSALUD) {
    return new Promise((resolve, reject) => {
      MEDICAMENTOS.forEach((MEDICAMENTO) => {
        ...
        connection.connection.query(medicamentoquery, (err, resultadoquerymedicamento) => {
          if (err) {
            reject(err);
          } else {
